...
const HowToWrite = ({ navigation}) => {
      
      return(
        <SafeAreaView style={{ flex: 1 }}>
          <ScrollView scrollEventThrottle={16}>
              <View style={styles.container}>
                  <Text style={{fontSize: 30, fontWeight: "700" ,paddingHorizontal: 5, color: '#800000'}}>How to Write a Winning CV!</Text>
                  <Image style={{marginTop: 10, width: '95%', height: 200}} source={require('../assets/courses/How-to-Write-a-Winning-CV.png')}/>
                  ...
                  <View style={{paddingBottom: 20,width: '95%'}}>
                      ...
                      <Text>
                       This course will guide you on how to write and formulate a winning curriculum vitae
                      </Text>
                      <Text>
                       that will get you a job interview or even better your dream job.
                      </Text>
                  </View>
                </View>
              </View>
